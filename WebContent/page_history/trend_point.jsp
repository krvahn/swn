...
<script type="text/javascript" language="javascript">
	...
	function updateChart()
	{
		...
		$("#titleFileName").val("측정항목별 트렌드 - " + $('#search_ReportType option:selected').text() + " - " + sWorkDate);
		jQuery.ajax({
			type: "GET",
			url: URL,
			async: false,
...
<body style="background:#FFFFFF;">
	...
	<tr>
		<td>
			...
			<tr>
				<td width=133 height=20 style="background-image:url(${pageContext.request.contextPath}/images/comm/20081212_swn_atab02_ov.jpg); padding-top:5px;" align="center"><a href="javascript:menuSelectWithPath('2', '2', '1', '', '${pageContext.request.contextPath}');"><font color=white><b>측정지점별</b></font></a></td>
				<td width=2></td>
