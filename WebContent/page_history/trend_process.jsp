...
bUpdate = true;
if( paramWWCode.equals("") || paramAnalItem.equals("") ) {
	bUpdate = false;
...
<script type="text/javascript" language="javascript">
	...
	var g_urlChartData = "history.page.do?Act=trend.process";
	var oChart;
	...
	function updateChart()
	{
		...
		$("#titleFileName").val("정수처리공정간 트렌드 - " + $('#search_ReportType option:selected').text() + " - " + sWorkDate);
		jQuery.ajax({
			type: "GET",
			url: URL,
			async: false,
...
<body style="background:#FFFFFF;">
	...
	<tr>
		<td>
			...
			<tr>
				...
				<td width=2></td>
				<td width=133 height=20 style="background-image:url(${pageContext.request.contextPath}/images/comm/20081212_swn_atab02_ov.jpg); padding-top:5px;" align="center"><a href="javascript:menuSelectWithPath('2', '2', '4', '', '${pageContext.request.contextPath}');"><font color=white><b>정수처리공정간</b></font></a></td>
				<td width=2></td>
	...
	<tr>
		<td>
			...
			<tr>
				<td width=10% class='swn_tbl_title'>측정위치 선택</td>
