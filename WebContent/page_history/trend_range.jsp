...
bUpdate = true;
if( paramWWCode.equals("") || paramItems.equals("") ) {
	bUpdate = false;
...
<script type="text/javascript" language="javascript">
	...
	var g_urlChartData = "history.page.do?Act=trend.range";
	var oChart;
	...
	function updateChart()
	{
		...
		$("#titleFileName").val("측정지점간 트렌드 - " + $('#search_ReportType option:selected').text() + " - " + sWorkDate);
		jQuery.ajax({
			type: "GET",
			url: URL,
			async: false,
	...
	$(document).ready(function() {
		...
		// 측정항목 선택
		if( "<%=paramAnalItem%>" != "" ) {
			$("#search_AnalItem").val('<%=paramAnalItem%>');
		} else {
			$("#search_AnalItem option:eq(0)").attr("selected","selected");
		}
...
<body style="background:#FFFFFF;">
	...
	<tr>
		<td>
			...
			<tr>
				...
				<td width=2></td>
				<td width=133 height=20 style="background-image:url(${pageContext.request.contextPath}/images/comm/20081212_swn_atab02_ov.jpg); padding-top:5px;" align="center"><a href="javascript:menuSelectWithPath('2', '2', '2', '', '${pageContext.request.contextPath}');"><font color=white><b>수계내 측정지점간</b></font></a></td>
				<td width=2></td>
	...
	<tr>
		<td>
			...
			<tr>
				<td width=10% class='swn_tbl_title'>측정항목</td>
	...
	<tr>
		<td align=right><a href="javascript:fnTrend();"><img src="${pageContext.request.contextPath}/images/comm/20081212_swn_btn_trend.gif" border=0 ></a></td>
	</tr>
