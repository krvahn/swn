...
//권한 검사
curPage.checkAuthority(WebConst.AUTH_STAUTS_TOP_ADD, true, false); 
%>
...
<script type="text/javascript" language="javascript">
	...
	var g_urlReport = "system.page.do?Act=status_top.list";
	var oReport;
	...
	function fnAdd()
	{
		...
		URL = g_contextPath + "/status_top_form.do";
		URL += "?MODE=add";
		
		document.location.href = URL;
	}
	
	function fnUpdate(topCode)
	{
		var URL;
	...
	function fnDelete(topCode)
	{
		var nDel;
		var URL;		
		
		nDel = confirm("선택한 데이터를 삭제하시겠습니까?..\n\n 데이터를 삭제하면 해당 측정상태의 5분 측정값을 읽을수 없습니다.");
...
<body style="background:#FFFFFF;">
	...
	<tr>
		<td>
			<img src="${pageContext.request.contextPath}/images/system/20090511_swn_stitle03.jpg">
		</td>
	</tr>
	...
	<table width=100% height=100% cellspacing=1 cellpadding=0 id="report">
		<thead>
		<tr>
			<th align=center height=30 width=25% bgcolor="#EFEFEF">상태 정보 코드</th>
			<th align=center width=45% bgcolor="#EFEFEF">상태 정보명</th>
			<th align=center width=20% bgcolor="#EFEFEF">사용 여부</th>
