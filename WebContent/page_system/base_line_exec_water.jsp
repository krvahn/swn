...
//권한 검사
curPage.checkAuthority(WebConst.AUTH_BASE_LINE_EXEC_WATER, true, false);
...
bUpdate = true;
if( paramWWCode.equals("") || paramPointCode.equals("")) {
	bUpdate = false;
...
<script type="text/javascript" language="javascript">
	...
	var g_urlReportData = "system.page.do?Act=base_line_exec.water";
	var oReport;
...
<body style="background:#FFFFFF;">
	...
	<tr>
		<td>
			...
			<tr>
				<td width=133 height=20 style="background-image:url(${pageContext.request.contextPath}/images/comm/20081212_swn_atab02.jpg); padding-top:5px;" align="center"><a href="javascript:menuSelectWithPath('99', '6', '1', '', '${pageContext.request.contextPath}');"><font color=blue><b>정수센터</b></font></a></td>
				<td width=2></td>
				<td width=133 height=20 style="background-image:url(${pageContext.request.contextPath}/images/comm/20081212_swn_atab02_ov.jpg); padding-top:5px;" align="center"><a href="javascript:menuSelectWithPath('99', '6', '2', '', '${pageContext.request.contextPath}');"><font color=white><b>수도사업소</b></font></a></td>
			</tr>
			</table>
		</td>		
	</tr>
	...
	<table width=100% height=100% cellspacing=1 cellpadding=0 id='report'>
		...
		<tr>
			...
			<th colspan=2 align=center bgcolor=#EFEFEF>기준치</th>
			<th rowspan=2 align=center bgcolor=#EFEFEF>측정치</th>
		</tr>
		<tr>
			<th align=center bgcolor=#EFEFEF>최상한</th>
