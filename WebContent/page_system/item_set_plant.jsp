...
<body style="background:#FFFFFF;">
	...
	<tr>
		<td>
			<img src="${pageContext.request.contextPath}/images/system/20090506_swn_stitle24.jpg">
		</td>
	</tr>
	<tr>
		<td>
			...
			<tr>
				<td width=133 height=20 style="background-image:url(${pageContext.request.contextPath}/images/comm/20081212_swn_atab02_ov.jpg); padding-top:5px;" align="center"><a href="javascript:menuSelectWithPath('99', '4', '2', '', '${pageContext.request.contextPath}');"><font color=white><b>정수센터</b></font></a></td>
				<td width=2></td>
				<td width=133 height=20 style="background-image:url(${pageContext.request.contextPath}/images/comm/20081212_swn_atab02.jpg); padding-top:5px;" align="center"><a href="javascript:menuSelectWithPath('99', '4', '3', '', '${pageContext.request.contextPath}');"><font color=blue><b>수도사업소</b></font></a></td>
			</tr>
			</table>
		</td>		
	</tr>
	...
	<tr>
		<td>
			...
			<tr>
				...
				<td style="background-color:white; text-align:left; padding-left:5px">
					<select id="search_FactoryCode" style="width:130px; vertical-align:middle;">
					</select>&nbsp;					
