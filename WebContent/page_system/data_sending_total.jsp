...
//권한 검사
curPage.checkAuthority(WebConst.AUTH_DATA_SENDING_TOTAL, true, false);
...
<script type="text/javascript" language="javascript">
	...
	var g_urlReport = "system.page.do?Act=data_sending.total";
	var oReport;
	...
	$(document).ready(function() {
		...
		// 파일명 및 인쇄 프린트 타이틀 넣기
		$("#titleFileName").val("자료전송현황_종합요약");
		$("#titlePrintPage").val("자료전송현황 종합요약");
	});
</script>
<body style="background:#FFFFFF;">
	...
	<tr>
		<td>
			<img src="${pageContext.request.contextPath}/images/system/20090506_swn_stitle01.jpg">
		</td>
	</tr>
	...
	<table width=100% height=100% cellspacing=1 cellpadding=0 id="report">
		...
		<tr>
			...
			<th align=center width=40% bgcolor="#EFEFEF">사업소명</th>
