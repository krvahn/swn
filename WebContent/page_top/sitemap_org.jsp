...
%>							
			...
			<tr>
				<td width=191 valign=top>
					<table width=100% cellspacing=0 cellpadding=0>
					<tr>
						<td height=29 background="${pageContext.request.contextPath}/images/top/20090506_swn_sitemap_bg01.gif" style="padding-top:3px; padding-left:10px;"><font color=white><b>시스템 관리</b></font></td>
					</tr>
					<tr><td height=5></td></tr>
					<tr>
						<td height=26 style="padding-left:10px; padding-top:2px;"><a href="#" onClick="menuSelectWithPath('99', '1', '1', '', '${pageContext.request.contextPath}');"><b>ㆍ자료전송현황</b></a></td>
					</tr>
					<tr><td><img src="${pageContext.request.contextPath}/images/top/20090506_swn_sitemap_line01.gif"></td></tr>
					<tr>
						<td>
							...
							<tr><td height=7></td></tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '1', '1', '', '${pageContext.request.contextPath}');">종합 요약</a></td>
							</tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '1', '2', '<%=WebConst.SWQ_FIRST_PCODE%>', '${pageContext.request.contextPath}');">아리수정수센터</a></td>
							</tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '1', '3', '<%=WebConst.SWQ_FIRST_WCODE%>', '${pageContext.request.contextPath}');">수도사업소</a></td>
							</tr>
							<tr><td height=15></td></tr>
							</table>
						</td>
					...
					<tr>
						<td height=26 style="padding-left:10px; padding-top:2px;"><a href="#" onClick="menuSelectWithPath('99', '2', '1', '', '${pageContext.request.contextPath}');"><b>ㆍ사용자 관리</b></a></td>
					</tr>
					<tr><td><img src="${pageContext.request.contextPath}/images/top/20090506_swn_sitemap_line01.gif"></td></tr>
					<tr>
						<td>
							...
							<tr><td height=7></td></tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '2', '1', '', '${pageContext.request.contextPath}');">사용자 그룹 관리</a></td>
							</tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '2', '2', '', '${pageContext.request.contextPath}');">사용자 정보 관리</a></td>
							</tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '2', '3', '', '${pageContext.request.contextPath}');">사업소 담당자 정보</a></td>
							</tr>
							<tr><td height=15></td></tr>
							</table>
						</td>
					...
					<tr>
						<td height=26 style="padding-left:10px; padding-top:2px;"><a href="#" onClick="menuSelectWithPath('99', '3', '1', '<%=WebConst.SWQ_FIRST_PCODE%>', '${pageContext.request.contextPath}');"><b>ㆍ측정 포인트 관리</b></a></td>
					</tr>
					<tr><td><img src="${pageContext.request.contextPath}/images/top/20090506_swn_sitemap_line01.gif"></td></tr>
					<tr>
						<td>
							...
							<tr><td height=7></td></tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '3', '1', '<%=WebConst.SWQ_FIRST_PCODE%>', '${pageContext.request.contextPath}');">아리수정수센터</a></td>
							</tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '3', '2', '<%=WebConst.SWQ_FIRST_WCODE%>', '${pageContext.request.contextPath}');">수도사업소</a></td>
							</tr>
							<tr><td height=15></td></tr>
							</table>
						</td>
					...
					<tr>
						<td height=26 style="padding-left:10px; padding-top:2px;"><a href="#" onClick="menuSelectWithPath('99', '4', '1', '', '${pageContext.request.contextPath}');"><b>ㆍ측정 항목 관리</b></a></td>
					</tr>
					<tr><td><img src="${pageContext.request.contextPath}/images/top/20090506_swn_sitemap_line01.gif"></td></tr>
					<tr>
						<td>
							...
							<tr><td height=7></td></tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '4', '1', '', '${pageContext.request.contextPath}');">측정항목 리스트</a></td>
							</tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '4', '2', '', '${pageContext.request.contextPath}');">측정항목 설정(정수)</a></td>
							</tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '4', '3', '', '${pageContext.request.contextPath}');">측정항목 설정(수도)</a></td>
							</tr>
							<tr><td height=15></td></tr>
							</table>
						</td>
					...
					<tr>
						<td height=26 style="padding-left:10px; padding-top:2px;"><a href="#" onClick="menuSelectWithPath('99', '5', '1', '', '${pageContext.request.contextPath}');"><b>ㆍ상태정보 관리</b></a></td>
					</tr>
					<tr><td><img src="${pageContext.request.contextPath}/images/top/20090506_swn_sitemap_line01.gif"></td></tr>
					<tr>
						<td>
							...
							<tr><td height=7></td></tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '5', '1', '', '${pageContext.request.contextPath}');">상태정보 소분류</a></td>
							</tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '5', '2', '', '${pageContext.request.contextPath}');">상태정보 대분류</a></td>
							</tr>
							<tr><td height=15></td></tr>
							</table>
						</td>
					...
					<tr>
						<td height=26 style="padding-left:10px; padding-top:2px;"><a href="#" onClick="menuSelectWithPath('99', '6', '1', '<%=WebConst.SWQ_FIRST_PCODE%>', '${pageContext.request.contextPath}');"><b>ㆍ기준치 초과 이력</b></a></td>
					</tr>
					<tr><td><img src="${pageContext.request.contextPath}/images/top/20090506_swn_sitemap_line01.gif"></td></tr>
					<tr>
						<td>
							...
							<tr><td height=7></td></tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '6', '1', '<%=WebConst.SWQ_FIRST_PCODE%>', '${pageContext.request.contextPath}');">아리수정수센터</a></td>
							</tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '6', '2', '<%=WebConst.SWQ_FIRST_WCODE%>', '${pageContext.request.contextPath}');">수도사업소</a></td>
							</tr>
							<tr><td height=15></td></tr>
							</table>
						</td>
					...
					<tr>
						<td height=26 style="padding-left:10px; padding-top:2px;"><a href="#" onClick="menuSelectWithPath('99', '7', '1', '<%=WebConst.SWQ_FIRST_PCODE%>', '${pageContext.request.contextPath}');"><b>ㆍSMS전송 이력 조회</b></a></td>
					</tr>
					<tr><td><img src="${pageContext.request.contextPath}/images/top/20090506_swn_sitemap_line01.gif"></td></tr>
					<tr>
						<td>
							...
							<tr><td height=7></td></tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '7', '1', '<%=WebConst.SWQ_FIRST_PCODE%>', '${pageContext.request.contextPath}');">아리수정수센터</a></td>
							</tr>
							<tr>
								<td height=17><a href="#" onClick="menuSelectWithPath('99', '7', '2', '<%=WebConst.SWQ_FIRST_WCODE%>', '${pageContext.request.contextPath}');">수도사업소</a></td>
							</tr>
							<tr><td height=15></td></tr>
							</table>
						</td>
					...
					<tr>
						<td height=26 style="padding-left:10px; padding-top:2px;"><a href="#" onClick="menuSelectWithPath('99', '8', '1', '', '${pageContext.request.contextPath}');"><b>ㆍ측정기 관리</b></a></td>
					</tr>
					<tr><td><img src="${pageContext.request.contextPath}/images/top/20090506_swn_sitemap_line01.gif"></td></tr>
					</table>
				</td>
