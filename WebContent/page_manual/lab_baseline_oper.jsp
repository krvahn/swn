...
<script type="text/javascript" language="javascript">
	...
	{	
		...
		// 날짜 넣기
		$("#list_text").html(wwName + " 정수장 개요 및 정수처리기준 운영 결과 (" + workDate.substr(0, 4) + "년 " + workDate.substr(4, 2) + "월)");
		...
		// 파일명 및 인쇄 프린트 타이틀 넣기
		$("#titleFileName").val(wwName + "_" + "정수처리기준운영결과_" + workDate);
		$("#titlePrintPage").val(wwName + " 정수처리기준 운영 결과 " + "(" + workDate.substr(0, 4) + "년 " + workDate.substr(4, 2) + "월)");
	}
...
<body style="background:#FFFFFF;">
	...
	<tr>
		<td>
			...
			<tr>
				...
				<td width=2></td>
				<td width=160 height=20 style="background-image:url(${pageContext.request.contextPath}/images/comm/20081212_swn_atab03_ov.jpg); padding-top:5px;" align="center"><a href="javascript:menuSelectWithPath('3', '1', '3', '', '${pageContext.request.contextPath}');"><font color=white><b>정수처리기준 운영결과</b></font></a></td>
			</tr>
			</table>
		</td>		
	</tr>
	...
	<div id="report_form">
		...
		<thead>
		<tr>
			<th height=25 width=50% colspan=2 align=center bgcolor=#EFEFEF>구분</th>
			<th width=50%  align=center bgcolor=#EFEFEF>내용</th>
		</tr>
