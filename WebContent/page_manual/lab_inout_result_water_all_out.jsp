...
<body style="background:#FFFFFF;">
			...
			<tr>
				...
				<td width=40% style="background-color:white; text-align:left; padding-left:5px">
					<select id="search_WaterType" style="width:130px;">
						...
						<option value="P" selected>정수</option>
					</select>
				</td>
			...
			<tr>
				...
				<td width=40% style="background-color:white; text-align:left; padding-left:5px">
					<select id="search_ItemKind" style="width:260px;">
						<option value="item_55" selected>55항목</option>
					</select>
				</td>	
	...
	<div id="report_form">
		<table width=100% height=100% cellspacing=1 cellpadding=0 id='report'>
			<thead>
			<tr>
				<th height=75 width=6% rowspan=3 align=center bgcolor=#EFEFEF>구분</th>				
				<th width=5% rowspan=3 align=center bgcolor=#EFEFEF>연번</th>
				<th width=15% rowspan=3 align=center bgcolor=#EFEFEF>측정항목</th>
				<th height=50 colspan=2 rowspan=2 align=center bgcolor=#EFEFEF>수질환경기준 (mg/L)</th>
				<th colspan=2 rowspan=2 align=center bgcolor=#EFEFEF>먹는물 수질기준 (mg/L)</th>
				<th colspan=12 align=center bgcolor=#EFEFEF>수질검사결과</th>
			</tr>				
			<tr>
				<th rowspan=2 align=center bgcolor=#EFEFEF>광암</th>
				<th colspan=2 align=center bgcolor=#EFEFEF>구의</th>
				<th colspan=3 align=center bgcolor=#EFEFEF>뚝도</th>
				<th colspan=3 align=center bgcolor=#EFEFEF>영등포</th>
