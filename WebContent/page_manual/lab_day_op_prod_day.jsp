...
<script type="text/javascript" language="javascript">
	...
	var g_reportDataURL = "manual_search_day.page.do?Act=lab_day_op_prod_day.list";
	var oReport;
	...
	{	
		...
		// 파일명 및 인쇄 프린트 타이틀 넣기
		$("#titleFileName").val("정수센터일일운영_일일생산량현황"
				+ "_" + workDate);
...
<body style="background:#FFFFFF;">
			...
			<tr>
				...
				<td width=40% style="background-color:white; text-align:left; padding-left:5px">
					<select id="search_ReportNextType" style="width:260px;">
						<option value='0' selected>일일 생산량 보고</option>
	...
	<div id="report_form">	
		...
		<tr>
			<td>
				<img src='${pageContext.request.contextPath}/images/comm/20081212_swn_dbullet01.gif' style='margin-bottom:2px; margin-right:4px;'><b><font color=#003750>일일 생산량 보고&nbsp;<span id="list_date"></span></font></b>
			</td>
		</tr>
		</table>
		<table width=100% height=100% cellspacing=1 cellpadding=0 id='report'>
			<thead>
			<tr>
				<th height=25 width=20% colspan=2 align=center bgcolor=#EFEFEF>구분</th>
				<th width=9% align=center bgcolor=#EFEFEF>합계</th>
				<th width=9% align=center bgcolor=#EFEFEF>광암</th>
				<th width=9% align=center bgcolor=#EFEFEF>구의</th>
				<th width=9% align=center bgcolor=#EFEFEF>뚝도</th>
				<th width=9% align=center bgcolor=#EFEFEF>영등포</th>
				<th width=9% align=center bgcolor=#EFEFEF>암사</th>
				<th width=9% align=center bgcolor=#EFEFEF>강북</th>
				<th width=9% align=center bgcolor=#EFEFEF>최저기온</th>
				<th width=9% align=center bgcolor=#EFEFEF>최고기온</th>
			</tr>
