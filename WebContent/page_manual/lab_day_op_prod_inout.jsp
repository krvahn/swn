...
<script type="text/javascript" language="javascript">
	...
	var g_reportDataURL = "manual_search_day.page.do?Act=lab_day_op_prod_inout.list";
	var oReport;
	...
	{	
		...
		// 파일명 및 인쇄 프린트 타이틀 넣기
		$("#titleFileName").val("정수센터일일운영_정수장별취수량및생산량현황"
				+ "_" + workDate.substr(0, 4) + workDate.substr(4, 2));
		$("#titlePrintPage").val("정수센터 일일 운영 정수장별 취수량 및 생산량 현황"
	...
	$(document).ready(function() {
		...
		URL = "code.list.do?Act=none&COLSPAN=15";
...
<body style="background:#FFFFFF;">
			...
			<tr>
				...
				<td width=40% style="background-color:white; text-align:left; padding-left:5px">
					<select id="search_ReportNextType" style="width:260px;">
						...
						<option value='2' selected>정수장별 취수량 및 생산량 현황</option>
						<option value='3'>공장별 생산량 현황</option>
					</select>					
				</td>
			</tr>
			</table>
	...
	<div id="report_form">	
		...
		<tr>
			<td>
				<img src='${pageContext.request.contextPath}/images/comm/20081212_swn_dbullet01.gif' style='margin-bottom:2px; margin-right:4px;'><b><font color=#003750>정수장별 취수량 및 생산량 현황&nbsp;<span id="list_date"></span></font></b>
			</td>
		</tr>
		</table>
		<table width=100% height=100% cellspacing=1 cellpadding=0 id='report'>
			<thead>
			<tr>
				<th height=50 width=8% rowspan=2 align=center bgcolor=#EFEFEF>일자</th>
				<th colspan=2 align=center bgcolor=#EFEFEF>총계</th>
				<th colspan=2 align=center bgcolor=#EFEFEF>광암</th>
				<th colspan=2 align=center bgcolor=#EFEFEF>구의</th>
				<th colspan=2 align=center bgcolor=#EFEFEF>뚝도</th>
				<th colspan=2 align=center bgcolor=#EFEFEF>영등포</th>
				<th colspan=2 align=center bgcolor=#EFEFEF>암사</th>
				<th colspan=2 align=center bgcolor=#EFEFEF>강북</th>
			</tr>
			<tr>
				<td width=6% bgcolor=#EFEFEF><center>취수량</center></td>
				<td width=6% bgcolor=#EFEFEF><center>생산량</center></td>
				<td width=5% bgcolor=#EFEFEF><center>취수량</center></td>
				<td width=5% bgcolor=#EFEFEF><center>생산량</center></td>
				<td width=5% bgcolor=#EFEFEF><center>취수량</center></td>
				<td width=5% bgcolor=#EFEFEF><center>생산량</center></td>
				<td width=5% bgcolor=#EFEFEF><center>취수량</center></td>
				<td width=5% bgcolor=#EFEFEF><center>생산량</center></td>
