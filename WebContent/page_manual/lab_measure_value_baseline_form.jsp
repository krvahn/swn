...
<script type="text/javascript" language="javascript">
	...
	var g_reportDataURL = "manual_value.page.do?Act=lab_manual_value_baseline.list";
	var oReport = null;
...
<body style="background:#FFFFFF;">
			...
			<tr>
				...
				<td colspan=3 style="background-color:white; text-align:left; padding-left:5px">
					<select id="search_ReportType" style="width:150px;">
						...
						<option value='2' selected>정수처리기준 운영결과</option>
	...
	<form name="sendForm" method="POST" action="${pageContext.request.contextPath}/page_manual/lab_measure_value_baseline_form.do">
	...
	<div id="report_form">	
		...
		<thead>
		<tr height=25>
			<th width=50% colspan=3 align=center bgcolor=#EFEFEF>구분</th>
			<th width=50% colspan=2 align=center bgcolor=#EFEFEF>내용</th>
		</tr>
