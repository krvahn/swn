...
<script type="text/javascript" language="javascript">
	...
	{	
		...
		// 파일명 및 인쇄 프린트 타이틀 넣기
		$("#titleFileName").val("정수센터일일운영수질현황"
				+ "_" + workDate);
		$("#titlePrintPage").val("정수센터 일일 운영 수질 현황"
				+ "(" + workDate + ")");
	}
...
<body style="background:#FFFFFF;">
			...
			<tr>
				...
				<td style="background-color:white; text-align:left; padding-left:5px">
					<select id="search_ReportType" style="width:130px;">
						<option value='0' selected>수질 현황</option>
	...
	<div id="report_form">	
		...
		<tr>
			<td>
				<img src='${pageContext.request.contextPath}/images/comm/20081212_swn_dbullet01.gif' style='margin-bottom:2px; margin-right:4px;'><b><font color=#003750>상수도 생산 및 수질 현황&nbsp;<span id="list_date"></span></font></b>
			</td>
			<td height=20 align=right bgcolor=#FFFFFF><b>* 수질현황은 일 평균임.</b></td>
		</tr>
		</table>
		<table width=100% height=100% cellspacing=1 cellpadding=0 id='report'>
			<thead>
			<tr>
				<th height=25 width=30% colspan=3 align=center bgcolor=#EFEFEF>구분</th>
				<th width=10% align=center bgcolor=#EFEFEF>합계(평균)</th>
