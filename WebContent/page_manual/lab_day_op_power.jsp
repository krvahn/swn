...
<script type="text/javascript" language="javascript">
	...
	var g_reportDataURL = "manual_search_day.page.do?Act=lab_day_op_power.list";
	var oReport;
	...
	{	
		...
		// 파일명 및 인쇄 프린트 타이틀 넣기
		$("#titleFileName").val("정수센터일일운영_전력사용량현황"
				+ "_" + workDate.substr(0, 4) + workDate.substr(4, 2));
		$("#titlePrintPage").val("정수센터 일일 운영 전력 사용량 현황"
...
<body style="background:#FFFFFF;">
			...
			<tr>
				...
				<td style="background-color:white; text-align:left; padding-left:5px">
					<select id="search_ReportType" style="width:130px;">
						...
						<option value='4' selected>전력사용량 현황</option>
					</select>					
				</td>
			</tr>
			<tr>
	...
	<div id="report_form">	
		...
		<tr>
			<td>
				<img src='${pageContext.request.contextPath}/images/comm/20081212_swn_dbullet01.gif' style='margin-bottom:2px; margin-right:4px;'><b><font color=#003750>전력 사용량 현황&nbsp;<span id="list_date"></span></font></b>
			</td>
		</tr>
		</table>
		<table width=100% height=100% cellspacing=1 cellpadding=0 id='report'>
			<thead>
			<tr>
				<th height=50 width=16% rowspan=2 colspan=2 align=center bgcolor=#EFEFEF>사업소명</th>
				<th rowspan=2 width=12% align=center bgcolor=#EFEFEF>계약전력<br>(kWh)</th>
				<th colspan=2 align=center bgcolor=#EFEFEF>Peak (kWh)</th>
				<th colspan=4 align=center bgcolor=#EFEFEF>전력 사용량</th>
			</tr>
			<tr>
				<th width=12% bgcolor=#EFEFEF><center>금월</center></th>
				<th width=12% bgcolor=#EFEFEF><center>전월</center></th>
				<th width=12% bgcolor=#EFEFEF><center>계</center></th>
				<th width=12% bgcolor=#EFEFEF><center>주간</center></th>
				<th width=12% bgcolor=#EFEFEF><center>저녁</center></th>
				<th width=12% bgcolor=#EFEFEF><center>심야</center></th>
			</tr>
