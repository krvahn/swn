...
<script type="text/javascript" language="javascript">
	...
	{	
		...
		// 날짜 넣기
		$("#prev_date").html("(" + (workDate.substr(0, 4) - 1) + "년 " + workDate.substr(4, 2) + "월" + ")");
		$("#cur_date").html("(" + workDate.substr(0, 4) + "년 " + workDate.substr(4, 2) + "월" + ")");
		...
		// 파일명 및 인쇄 프린트 타이틀 넣기
		$("#titleFileName").val("정수센터일일운영_연도별일일생산량현황"
				+ "_" + workDate.substr(0, 4) + workDate.substr(4, 2));
		$("#titlePrintPage").val("정수센터 일일 운영 년도별 일일 생산량 현황"
...
<body style="background:#FFFFFF;">
			...
			<tr>
				...
				<td width=40% style="background-color:white; text-align:left; padding-left:5px">
					<select id="search_ReportNextType" style="width:260px;">
						...
						<option value='1' selected>년도별 일일 생산량 현황</option>
	...
	<div id="report_form">	
		...
		<tr>
			<td>
				<img src='${pageContext.request.contextPath}/images/comm/20081212_swn_dbullet01.gif' style='margin-bottom:2px; margin-right:4px;'><b><font color=#003750>년도별 일일 생산량 현황</font></b>
			</td>
		</tr>
		</table>
		<table width=100% height=100% cellspacing=1 cellpadding=0 id='report'>
			<thead>
			<tr>
				<th height=75 width=10% rowspan=2 align=center bgcolor=#EFEFEF>구분</th>
				<th height=25 colspan=5 align=center bgcolor=#EFEFEF>전년 동월 <span id="prev_date"></span></th>
				<th colspan=5 align=center bgcolor=#EFEFEF>금년 동월 <span id="cur_date"></span></th>
			</tr>
			<tr>
				<th height=50 width=7% align=center bgcolor=#EFEFEF>요일</th>
				<th width=9% align=center bgcolor=#EFEFEF>최저<br>기온</th>
				<th width=9% align=center bgcolor=#EFEFEF>최고<br>기온</th>
				<th width=9% align=center bgcolor=#EFEFEF>생산량<br>(m³)</th>
				<th width=11% align=center bgcolor=#EFEFEF>전년대비증감<br>(m³)</th>
				<th width=7% align=center bgcolor=#EFEFEF>요일</th>
				<th width=9% align=center bgcolor=#EFEFEF>최저<br>기온</th>
				<th width=9% align=center bgcolor=#EFEFEF>최고<br>기온</th>
				<th width=9% align=center bgcolor=#EFEFEF>생산량<br>(m³)</th>
				<th width=11% align=center bgcolor=#EFEFEF>전년대비증감<br>(m³)</th>
