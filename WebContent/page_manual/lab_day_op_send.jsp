...
<script type="text/javascript" language="javascript">
	...
	var g_reportDataURL = "manual_search_day.page.do?Act=lab_day_op_send.list";
	var oReport;
	...
	{	
		...
		// 파일명 및 인쇄 프린트 타이틀 넣기
		$("#titleFileName").val("정수센터일일운영송수현황"
				+ "_" + workDate);
		$("#titlePrintPage").val("정수센터 일일 운영 송수 현황"
				+ "(" + workDate + ")");
	}
	...
	$(document).ready(function() {
		...
		URL = "code.list.do?Act=none&COLSPAN=14";
...
<body style="background:#FFFFFF;">
			...
			<tr>
				...
				<td style="background-color:white; text-align:left; padding-left:5px">
					<select id="search_ReportType" style="width:130px;">
						...
						<option value='1' selected>송수 현황</option>
	...
	<div id="report_form">	
		...
		<tr>
			<td>
				<img src='${pageContext.request.contextPath}/images/comm/20081212_swn_dbullet01.gif' style='margin-bottom:2px; margin-right:4px;'><b><font color=#003750>송수현황&nbsp;<span id="list_date"></span></font></b>
			</td>
		</tr>
		</table>
		<table width=100% height=100% cellspacing=1 cellpadding=0 id='report'>
			<thead>
			<tr>
				<th rowspan=2 colspan=2 height=50 width=20% colspan=2 align=center bgcolor=#EFEFEF>정수장<br>(570만톤)</th>
				<th rowspan=2 width=10% align=center bgcolor=#EFEFEF>수계</th>
				<th colspan=2 width=12% align=center bgcolor=#EFEFEF>공급량(m3)</th>
				<th colspan=4 width=24% align=center bgcolor=#EFEFEF>관압(kg/cm3)</th>
				<th colspan=2 width=12% align=center bgcolor=#EFEFEF>시설현황</th>
				<th colspan=2 width=12% align=center bgcolor=#EFEFEF>펌프가동</th>
				<th rowspan=2 width=10% align=center bgcolor=#EFEFEF>비고</th>
			</tr>
			<tr>
				<th width=6% height=25 align=center bgcolor=#EFEFEF>금일</th>
				<th width=6% align=center bgcolor=#EFEFEF>전일</th>
				<th width=6% align=center bgcolor=#EFEFEF>금일</th>
				<th width=6% align=center bgcolor=#EFEFEF>전일</th>
				<th width=6% align=center bgcolor=#EFEFEF>최고</th>
				<th width=6% align=center bgcolor=#EFEFEF>최저</th>
				<th width=6% align=center bgcolor=#EFEFEF>마력</th>
				<th width=6% align=center bgcolor=#EFEFEF>대수</th>
				<th width=6% align=center bgcolor=#EFEFEF>대수</th>
				<th width=6% align=center bgcolor=#EFEFEF>시간</th>
			</tr>
