...
// 게시물 전체 개수 가져오기
nTotalCnt = (int) dao.selectOneOpenBoardListTotalCnt(params);
...
// 데이터 얻기
sErrorMessage = ""; 
boardList = dao.selectOpenBoardList(params);
			...
			<tr>
				<td>
					...
					<tr>
						...
						<td width=602 background="./images/20081212_swn_board_bg01.gif" align=center><img src="./images/20081212_swn_board_t02.gif"></td>
						<td width=80 background="./images/20081212_swn_board_bg01.gif" align=center><img src="./images/20081212_swn_board_t04.gif"></td>
					</tr>
					<tr>
						<td colspan=3 bgcolor=#00375D height=2></td>
					</tr>
<%
...
if( boardList != null && boardList.size() > 0 ) {	
	...
	while( it.hasNext() ) {
		...
		if(nNum != nToNum) {
			out.println("<tr>");
			out.println("<td height=1 colspan=3 background='./images/20081212_swn_board_line01.gif'></td>");
			out.println("</tr>");
		}	
	}
} else {
	out.println("<tr>");
	out.println("<td colspan=3 align=center>" + sErrorMessage + "</td>");
	out.println("</tr>");
}
%>
					<tr>
